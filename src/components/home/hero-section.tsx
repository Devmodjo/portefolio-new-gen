...
import { ArrowRight, Download, MessageCircle, Github, Gitlab, Linkedin } from "lucide-react";
      ...
      <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="space-y-8 animate-fade-in-up">
          <div className="space-y-4">
            <p className="text-primary font-medium text-lg title1">Hello welcome I'm,</p>
          ...
          <div className="flex space-x-4">
            ...
            >
              <MessageCircle className="w-5 h-5 animate-fade-in-up" />
            </a>
            <a
