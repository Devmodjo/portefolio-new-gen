...
const technologies: Technology[] = [
    ...
    },
    {
        ...
        transition: { duration: 4.0, repeat: Infinity, repeatType: "reverse", ease: "easeInOut", delay: 0.4 },
    ...
    },
    {
        ...
        transition: { duration: 3.5, repeat: Infinity, repeatType: "reverse", ease: "easeInOut", delay: 0.6 },
    ...
    },
    {
        ...
        transition: { duration: 3.7, repeat: Infinity, repeatType: "reverse", ease: "easeInOut", delay: 0.8 },
        whileHover: { scale: 1.2, rotate: -15, zIndex: 10 }
    },
    {
        name: "PostgreSQL",
        ...
        transition: { duration: 4.3, repeat: Infinity, repeatType: "reverse", ease: "easeInOut", delay: 1.0 },
    ...
    },
    {
        ...
        proficiency: 50,
        animate: { y: [0, -18, 0], rotate: [0, 14, -14, 0] },
        transition: { duration: 3.9, repeat: Infinity, repeatType: "reverse", ease: "easeInOut", delay: 1.2 },
    ...
    },
    {
        ...
        proficiency: 95,
        animate: { y: [0, 15, 0], rotate: [0, -8, 8, 0] },
        transition: { duration: 3.9, repeat: Infinity, repeatType: "reverse", ease: "easeInOut", delay: 1.6 },
        whileHover: { scale: 1.2, rotate: -12, zIndex: 10 }
    },
    {
        name: "GitHub",
        ...
        proficiency: 80,
        animate: { x: [0, -15, 0], rotate: [0, 10, -10, 0] },
        transition: { duration: 3.6, repeat: Infinity, repeatType: "reverse", ease: "easeInOut", delay: 1.8 },
        whileHover: { scale: 1.2, rotate: 15, zIndex: 10 }
    },
    {
        name: "GitLab",
        ...
        color: "#FCA326",
        proficiency: 60,
        animate: { x: [0, 18, 0], rotate: [0, -12, 12, 0] },
        transition: { duration: 3.8, repeat: Infinity, repeatType: "reverse", ease: "easeInOut", delay: 2.0 },
        whileHover: { scale: 1.2, rotate: -18, zIndex: 10 }
    },
    {
        name: "Postman",
        ...
        proficiency: 85,
        animate: { y: [0, -20, 0], rotate: [0, 10, -10, 0] },
        transition: { duration: 4.0, repeat: Infinity, repeatType: "reverse", ease: "easeInOut", delay: 2.2 },
        whileHover: { scale: 1.2, rotate: 15, zIndex: 10 }
    },
    {
        name: "Swagger",
        ...
        color: "#85EA2D",
        proficiency: 70,
        animate: { x: [0, 20, 0], rotate: [0, -14, 14, 0] },
        transition: { duration: 3.7, repeat: Infinity, repeatType: "reverse", ease: "easeInOut", delay: 2.4 },
        whileHover: { scale: 1.2, rotate: -20, zIndex: 10 }
    },
    {
        name: "Microservices",
        ...
        proficiency: 50,
        animate: { y: [0, -18, 0], rotate: [0, 14, -14, 0] },
        transition: { duration: 3.7, repeat: Infinity, repeatType: "reverse", ease: "easeInOut", delay: 2.6 },
        whileHover: { scale: 1.2, rotate: 20, zIndex: 10 }
    },
    {
        ...
        proficiency: 70,
        animate: { x: [0, -20, 0], rotate: [0, 12, -12, 0] },
        transition: { duration: 4.2, repeat: Infinity, repeatType: "reverse", ease: "easeInOut", delay: 2.8 },
        whileHover: { scale: 1.2, rotate: 15, zIndex: 10 }
    },
    {
        name: "Spring Cloud",
        ...
        proficiency: 60,
        animate: { y: [0, 20, 0], rotate: [0, -10, 10, 0] },
        transition: { duration: 3.9, repeat: Infinity, repeatType: "reverse", ease: "easeInOut", delay: 3.0 },
        whileHover: { scale: 1.2, rotate: -15, zIndex: 10 }
    },
];
